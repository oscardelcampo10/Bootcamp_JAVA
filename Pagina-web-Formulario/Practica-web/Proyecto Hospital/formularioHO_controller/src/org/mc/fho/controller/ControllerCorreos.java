 ...
 */
public class ControllerCorreos {

    public static void enviarConGMail(String destinatario, String asunto, String cuerpo) {
        // Esto es lo que va delante de @gmail.com en tu cuenta de correo. Es el remitente también.
    String remitente = "medicacampestreexpomaternidad";  //Para la dirección nomcuenta@gmail.com
    ...
    "mail.smtp.clave", "szstnraxeesrqwtg");    //La clave de la cuenta
    props.put (
    ...
    MimeMessage message = new MimeMessage(session);
        ...
        transport.connect("smtp.gmail.com", remitente, "szstnraxeesrqwtg");

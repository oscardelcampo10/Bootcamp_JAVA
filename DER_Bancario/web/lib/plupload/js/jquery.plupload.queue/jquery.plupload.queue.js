							...
							'<div class="plupload_filelist_footer">' +
								'<div class="plupload_file_name">' +
									'<div class="plupload_buttons">' +
										'<a href="#" class="plupload_button plupload_add gh_button small primary pill">' + _('Add files') + '</a>' +
										'<a href="#" class="plupload_button plupload_start gh_button small pill">' + _('Start upload') + '</a>' +
									'</div>' +

<%-- 
    Document   : cuenta_movimientos
    Created on : 20-jun-2012, 16:13:59
...
<%
            ...
            ArrayList<movimientos> lista=cargar.ObtenerMovimientos(Cuenta);
...
<head>
	...
	<title>ACM el banco de todos | Consultar Movimientos</title>
  ...
  <header>
		<div class="container head_s_a">
            ...
            <li>Usted esta en:</li>
						...
						<li><span>Consultar Movimientos</span></li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="row">
		    ...
		    <div class="box_c_content">
		      ...
		      <thead>
		            <tr>
		              ...
		              <th class="essential">Descripcion</th>
		     ...
		     <%for (movimientos m : lista){ %>
		        ...
		        <center>
		          ...
		          <small class="plupload_filelist_header"><b>s/. <%=c.getMonto()%></b></small>
	            </center>
	          </div>
	        </div>
	      </div>
  ...
  <p class="inner_heading">Banco de Todos ACM 2012. Todos los derechos reservados  © . Si tienes cualquier duda o consulta, comun<span lang="es-pe">íca</span>te con Banca por Tel<span lang="es-pe">é</span>fono V<span lang="es-pe">í</span>a ACM 044 451454 o al 948451245.</p>
	...
	<script src="lib/datatables/js/dataTables.plugins.js"></script>
    <script src="js/jquery.sparkline.min.js"></script>
	<script src="lib/datatables/extras/ColVis/media/js/ColVis.min.js"></script>

<%-- 
    ...
    Created on : 20-jun-2012, 16:25:28
...
<head>
	...
	<title>ACM el banco de todos | Cambiar Clave</title>
  ...
  <header>
		<div class="container head_s_a">
            ...
            <li>Usted esta en:</li>
						...
						<li><span>Cambiar mi Clave</span></li>
					</ul>
				</div>
			</div>
		</div>
  ...
  <div class="nine columns">
    <div class="box_c">
      <div class="box_c_heading cf">
        ...
        <p>Cambiar clave de cuenta Actual</p>
      </div>
      <div class="box_c_content">
          <form id="validate_wizard" class="stepy-wizzard nice" action="CambiarClave">
          <fieldset title="Datos de Cuenta Actual">
            <legend>Ingresar datos de Cuenta.</legend>
            <div class="row">
              <div class="twelve columns">
                <div class="formRow elVal">
                  <label for="clave_tarjeta1">Clave de Tarjeta (4 digitos)</label>
                  <input type="password" id="clave_tarjeta1" maxlength="4" name="clave_tarjeta1" class="input-text medium" />
                </div>
                <div class="formRow elVal">
                  <label for="clave_tarjeta2">Clave de Cuenta Actual (6 digitos)</label>
                  <input type="password" id="clave_tarjeta2" maxlength="6" name="clave_tarjeta2" class="input-text medium" />
                </div>
              </div>
            </div>
          </fieldset>
          <fieldset title="Cambiar Clave">
            <legend>Ingresar nuevos datos</legend>
            <div class="row">
              <div class="twelve columns">
                <div class="formRow elVal">
                  <label for="clave_tarjeta3">Nueva Clave de Tarjeta (6 digitos)</label>
                  <input type="hidden" value="<%=Cliente%>" id="cliente" name="cliente">
                  <input type="password" id="clave_tarjeta3" name="clave_tarjeta3"  maxlength="6" class="input-text medium" />
                </div>
                <div class="formRow elVal">
                  <label for="codcaptcha">Ingrese el codigo que muestra la imagen</label>
                  <span class="formRow"><br>
                  <img src="cap3.jsp" name="a" id="a" /> <a href="javascript:redi()"><img src="img/nvocodigo.png" width="99" height="11" border="0"></a></span>
<input type="text" id="codcaptcha" name="codcaptcha" class="input-text medium" maxlength="6" />
                </div>
              </div>
            </div>
          </fieldset>
          <button type="button" class="finish gh_button icon approve primary">Cambiar Clave</button>
        </form>
      </div>
    </div>
  </div>

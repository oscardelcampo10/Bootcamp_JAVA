<%-- 
    Document   : pago_servicio
    Created on : 22-jun-2012, 18:33:35
...
<head>
	...
	<title>ACM el banco de todos | Realizar Pago de Servicios</title>
    ...
    function obtener_monto(){ 
        var dni=document.formulario2.txtdni.value;
        if(dni=="47641184") 
        { 
            document.formulario2.txtmonto.value='8555555';
            if (855555 > <%=monto%>)
            {
                alert("El monto de pago es mayor al saldo disponible en la cuenta");
                location.href='cuenta_saldo.jsp';
            }
        }
        else if(dni=="12345678")
        {	
            document.formulario2.txtmonto.value='68.70'; 
            if (68.70 > <%=monto%>)
            {
                alert("El monto de pago es mayor al saldo disponible en la cuenta");
                location.href='cuenta_saldo.jsp';
	...
	<header>
		<div class="container head_s_a">
            ...
            <li>Usted esta en:</li>
						...
						<li><span>Pago de Servicios</span></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="nine columns">
		  <div class="box_c">
		    ...
		    <div class="box_c_content">
                        <form id="validate_wizard" class="stepy-wizzard nice" name="formulario2" action="ValidarOperacion">
		        <fieldset title="Datos de Servicio">
		          <legend>Monto y tipo</legend>
		          <div class="row">
		            <div class="twelve columns">
		              <div class="formRow elVal">
		                <label for="tipo_servicio">Seleccione Tipo de Servicio:</label>
		                <select data-placeholder="Seleccionar..." class="chzn-select" style="width:300px" name="tipo_servicio" id="tipo_servicio">
		                  <option value=""></option>
		              ...
		              <div class="formRow elVal">
		                <label for="txtdni">Ingrese Numero de DNI (Titular)</label>
                                ...
                                <input type="text" id="txtdni" name="txtdni" class="input-text medium" maxlength="8" />
                                <button type="button" onclick="javascript:obtener_monto()" class="button small nice blue radius">Buscar...</button>
	                  </div>
		              <div class="formRow elVal">
		                <label for="txtmonto">Monto a Pagar</label>
		                <input type="text" id="txtmonto" name="txtmonto" class="input-text medium"  readonly="readonly"/>
	                  </div>
	                </div>
	              </div>
	            </fieldset>
		          ...
		          <div class="row">
		            <div class="twelve columns">
		              <div class="formRow elVal">
		                ...
		                <br>
		                <img src="cap3.jsp" name="a" id="a" /> <a href="javascript:redi()"><img src="img/nvocodigo.png" width="99" height="11" border="0"></a>
		        ...
		        <button type="button" class="finish gh_button icon approve primary">Realizar Operacion</button>
	          </form>
	        </div>
	      </div>
  </div>

...
function Keypad() {
	...
	this.regional[''] = { // Default regional settings
		...
		buttonStatus: 'Abrir Teclado', // Status text for trigger button
		closeText: 'Cerrar', // Display text for close link
		closeStatus: 'Cerrar Teclado', // Status text for close link
		clearText: 'Limpiar', // Display text for clear link
		clearStatus: 'Erase all the text', // Status text for clear link
		backText: 'Borrar', // Display text for back link
